...
4. Use ferramentas para gerenciamento de estados como a [Zustand](https://github.com/pmndrs/zustand) e a [@bentoo/state-man](https://www.npmjs.com/package/@bentoo/state-man).
